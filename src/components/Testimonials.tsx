...
const Testimonials = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#112536] via-[#1D3B52] to-[#2E6A92] py-20 text-primary-foreground">
      <div className="absolute inset-y-0 right-[-12%] hidden h-[120%] w-[45%] rounded-full bg-[#2E6A92]/30 blur-3xl lg:block" />
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-lg text-white/75">
            Our partners span critical infrastructure, hospitality, education, and global enterprises. Hear how KREDENCE
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-3">
          {testimonials.map((testimonial) => (
            <article
              ...
              className="flex h-full flex-col rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-md transition hover:-translate-y-1 hover:bg-white/10 hover:shadow-2xl hover:shadow-[#2E6A92]/30"
            >
