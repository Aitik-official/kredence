        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-20 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground">
              Ready to start your steel or fencing project? Contact us today for a free consultation and quote.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              <div className="group flex items-start space-x-4 p-6 rounded-2xl bg-gradient-card border border-border hover:shadow-elegant transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-lg">971-565686811</p>
                </div>
              </div>
              ...
              <div className="group flex items-start space-x-4 p-6 rounded-2xl bg-gradient-card border border-border hover:shadow-elegant transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-lg">Kredencesteel@gmail.com</p>
                </div>
              </div>
              ...
              <div className="group flex items-start space-x-4 p-6 rounded-2xl bg-gradient-card border border-border hover:shadow-elegant transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-lg">Dubai, Abu Dhabi, UAE</p>
                </div>
              </div>
            </div>
            ...
            <form className="space-y-6 p-8 rounded-2xl bg-gradient-card border border-border shadow-elegant">
              ...
              <Button 
                type="submit" 
                className="w-full bg-gradient-accent hover:shadow-glow text-white h-12 text-base rounded-xl"
                size="lg"
              >
                Send Message
              </Button>
