    ...
    <section className="bg-[#F4F6F8] py-16 sm:py-20">
      <div className="container mx-auto flex flex-col gap-10 px-4 sm:px-6 lg:flex-row lg:items-center lg:gap-16 lg:px-8">
        <div className="max-w-md space-y-6 text-center lg:text-left">
          <h2 className="text-3xl font-extrabold uppercase tracking-wide text-[#2E6A92] sm:text-4xl">
            Browse by Sector
          </h2>
          <p className="text-lg text-[#4A5459]">
            We have a wealth of experience providing solutions for all sectors.
          </p>
          <a
            href="/applications"
            className="inline-flex items-center justify-center rounded-sm bg-[#2E6A92] px-8 py-3 text-base font-semibold uppercase tracking-wide text-white transition hover:bg-[#245676]"
          >
            Applications
          </a>
        </div>
        ...
        <div className="relative flex-1">
          ...
          <button
            ...
            className="absolute left-0 top-1/2 hidden -translate-y-1/2 rounded-full bg-white p-3 text-[#2E6A92] shadow-lg transition hover:bg-[#2E6A92] hover:text-white lg:flex disabled:cursor-not-allowed disabled:opacity-40"
          ...
          <button
            ...
            className="absolute right-0 top-1/2 hidden -translate-y-1/2 rounded-full bg-white p-3 text-[#2E6A92] shadow-lg transition hover:bg-[#2E6A92] hover:text-white lg:flex disabled:cursor-not-allowed disabled:opacity-40"
