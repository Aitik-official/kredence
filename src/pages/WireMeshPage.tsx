...
const WireMeshPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    metaDescription.setAttribute("content", " Reliable Heras fence contractor in Dubai supplying and installing high-quality temporary fencing across UAE. ");
    ...
    ogTitle.setAttribute("content", " Heras Fence contractor in Dubai – www. kredencesteel.com ");
    ...
    ogDescription.setAttribute("content", " Reliable Heras fence contractor in Dubai supplying and installing high-quality temporary fencing across UAE. ");
  }, []);
