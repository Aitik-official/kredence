...
const SkylightsPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    metaDescription.setAttribute("content", " Trusted GRP translucent sheets and skylights supplier in Dubai offering durable, UV-resistant daylighting solutions for industrial buildings.");
    ...
    ogTitle.setAttribute("content", " GRP Translucent Sheets Skylights supplier in Dubai– www. kredencesteel.com ");
    ...
    ogDescription.setAttribute("content", " Trusted GRP translucent sheets and skylights supplier in Dubai offering durable, UV-resistant daylighting solutions for industrial buildings.");
  }, []);
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
  ...
  const product = {
    ...
    description: "GRP Translucent Sheets - Corrugated & Flat Profiles for Skylights",
    detailedDescription: "GRP Translucent Sheets - Skylights from KREDENCE STEEL TRADING are high-quality translucent roofing sheets made from Glass Reinforced Polyester (GRP). These sheets provide natural daylighting solutions for industrial, commercial, and agricultural buildings, reducing the need for artificial lighting and creating bright, well-lit interior spaces. They are available in various profiles including corrugated and flat profiles to suit different architectural requirements. Corrugated profiles match the appearance of traditional roofing sheets while providing excellent light transmission, making them ideal for warehouses and industrial buildings. Flat profiles offer a modern and sleek appearance, suitable for contemporary architectural designs. GRP Translucent Sheets are made from high-quality materials including fiberglass and polyester resin, which provide excellent strength, durability, and weather resistance. They are UV-resistant and able to withstand harsh weather conditions including intense sunlight, rain, and wind. The translucent nature of these sheets allows natural light to enter the building while providing protection from the elements, creating comfortable and energy-efficient interior environments. GRP Translucent Sheets are lightweight and easy to install, making them ideal for both new construction and retrofit applications. They can be easily cut and shaped to fit specific requirements, allowing for flexible design solutions. These sheets are also easy to maintain and require minimal upkeep, making them a cost-effective daylighting solution. The natural light provided by GRP Translucent Sheets helps reduce energy consumption by reducing the need for artificial lighting during daylight hours, resulting in lower energy bills and improved sustainability. They are available in various light transmission levels and colors, allowing for customization to match specific design requirements. GRP Translucent Sheets are commonly used in warehouses, factories, agricultural buildings, and retail spaces where natural lighting is important.",
    specifications: [
      "Material: Glass Reinforced Polyester (GRP)",
      "Profiles: Corrugated, Flat",
      "Properties: UV-resistant, Weather-resistant, Lightweight",
      "Light Transmission: Various levels available",
      "Characteristics: Strong, Durable, Easy to install",
      "Benefits: Natural daylighting, Energy-efficient, Cost-effective",
      "Applications: Warehouses, Factories, Agricultural buildings, Retail spaces",
