...
const DrywallPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    metaDescription.setAttribute("content", " Trusted drywall partition systems supplier in Dubai offering high-quality gypsum partitions for commercial and residential interiors. ");
    ...
    ogTitle.setAttribute("content", " Drywall Partition Systems supplier in Dubai – www. kredencesteel.com ");
    ...
    ogDescription.setAttribute("content", " Trusted drywall partition systems supplier in Dubai offering high-quality gypsum partitions for commercial and residential interiors. ");
  }, []);
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
  ...
  const product = {
    ...
    description: "Gypsum Board Partition Systems - Single, Double & Fire-Resistant Systems",
    detailedDescription: "Drywall Partition Systems from KREDENCE STEEL TRADING are interior wall systems made from gypsum boards and metal studs. These systems provide flexible and cost-effective solutions for creating interior partitions in commercial and residential buildings. They are available in various configurations including single-layer, double-layer, and fire-resistant systems to suit different requirements. Single-layer systems are suitable for basic partitioning needs, providing a simple and cost-effective solution for dividing interior spaces. Double-layer systems offer enhanced sound insulation and fire resistance, making them ideal for offices, hotels, and residential buildings where privacy and noise control are important. Fire-resistant systems are designed to meet specific fire safety requirements, providing enhanced protection in case of fire. These systems are made from high-quality gypsum boards and metal studs, ensuring durability and structural integrity. The gypsum boards are fire-resistant and provide excellent sound insulation, creating comfortable and safe interior environments. The metal studs provide strong support and are easy to install, allowing for quick and efficient construction. Drywall partition systems are lightweight and easy to handle, making them ideal for retrofitting and renovation projects where traditional masonry walls would be impractical. They are also highly customizable, allowing for easy modification and reconfiguration as space requirements change. These systems are cost-effective, as they require less material and labor compared to traditional masonry walls, reducing overall construction costs. They are also faster to install, significantly reducing construction time. Drywall partition systems are versatile and can be used in various applications including offices, hotels, residential buildings, hospitals, schools, and retail spaces. They provide a clean and professional finish that can be easily painted or decorated to match any interior design style.",
    specifications: [
      "Systems: Single-layer, Double-layer, Fire-resistant",
      "Materials: Gypsum boards, Metal studs",
      "Thickness: Various thicknesses available",
      "Applications: Offices, Hotels, Residential buildings, Hospitals, Schools, Retail spaces",
      "Characteristics: Lightweight, Fire-resistant, Sound-insulating",
      "Benefits: Cost-effective, Easy to install, Flexible, Customizable",
      "Properties: Durable, Structural integrity, Easy to modify",
      "Finish: Clean, Professional, Paintable"
    ],
    applications: [
      "Offices",
      "Hotels",
