...
const GICoilsPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    metaDescription.setAttribute("content", " Trusted GI mill finish coils supplier in Dubai offering high-quality galvanized steel coils for industrial, construction and manufacturing applications.");
    ...
    ogTitle.setAttribute("content", " GI Mill Finish Coils supplier in Dubai – www. kredencesteel.com ");
    ...
    ogDescription.setAttribute("content", " Trusted GI mill finish coils supplier in Dubai offering high-quality galvanized steel coils for industrial, construction and manufacturing applications.");
  }, []);
