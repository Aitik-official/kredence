        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-10 mb-12">
            <div className="max-w-2xl space-y-4">
              ...
              <p className="text-lg text-muted-foreground">
                From coastal boardwalks to city rooftops, KREDENCE layouts respond to site-specific challenges with refined finishes.
              </p>
            </div>
            <Button
              asChild
