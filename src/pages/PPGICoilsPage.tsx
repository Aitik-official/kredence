...
const PPGICoilsPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    metaDescription.setAttribute("content", " PPGI color coated coils supplier in Dubai delivering consistent quality steel coils with competitive pricing and timely supply.");
    ...
    ogTitle.setAttribute("content", " PPGI Color Coated Coils Supplier in Dubai – www. kredencesteel.com ");
    ...
    ogDescription.setAttribute("content", " PPGI color coated coils supplier in Dubai delivering consistent quality steel coils with competitive pricing and timely supply.");
  }, []);
