...
const PurlinsPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    metaDescription.setAttribute("content", " Reliable Z and C purlins supplier in Dubai supplying precision-engineered purlins for warehouses and steel structures.");
    ...
    ogTitle.setAttribute("content", " Z and C Purlins Supplier in Dubai – www. kredencesteel.com ");
    ...
    ogDescription.setAttribute("content", " Reliable Z and C purlins supplier in Dubai supplying precision-engineered purlins for warehouses and steel structures.");
  }, []);
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
  ...
  const product = {
    ...
    description: "Z and C purlins - Various sizes",
    detailedDescription: "Z and C Purlins from KREDENCE STEEL TRADING are precision-engineered structural members used in roof and wall framing systems. Made from galvanized steel, these purlins provide essential support for roofing and cladding materials, distributing loads efficiently across the structure. Z purlins are characterized by their Z-shaped cross-section, which provides excellent load-bearing capacity and structural integrity. They are commonly used in larger span applications where increased strength is required. C purlins feature a C-shaped cross-section and are versatile structural members suitable for various applications, including roof framing, wall framing, and secondary structural support. Both Z and C purlins are available in various sizes and gauges to suit different structural requirements and load conditions. They are made from high-quality galvanized steel, which provides excellent corrosion resistance and durability, ensuring a long lifespan even in harsh environments. The galvanized coating protects the steel from rust and corrosion, making them ideal for outdoor applications. Z and C purlins are lightweight yet strong, making them easy to handle and install while providing excellent structural performance. They are designed to work efficiently with roofing and cladding materials, providing secure attachment points and ensuring proper load distribution. These purlins are commonly used in warehouses, industrial buildings, agricultural structures, and commercial buildings where reliable structural support is essential. They are easy to install and can be quickly assembled using standard connection methods, reducing construction time and labor costs. Z and C purlins are cost-effective structural solutions that provide excellent value for money, offering reliable performance at competitive prices.",
    specifications: [
      "Types: Z purlins, C purlins",
      "Material: Galvanized Steel",
      "Cross-section: Z-shaped, C-shaped",
      "Applications: Roof framing, Wall framing, Secondary structural support",
      "Characteristics: Lightweight, Strong, Corrosion-resistant",
      "Benefits: Easy to install, Cost-effective, Reliable performance",
      "Properties: Durable, Structural integrity, Load-bearing capacity",
      "Sizes: Various sizes and gauges available"
    ],
    applications: [
      "Warehouses",
