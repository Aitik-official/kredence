...
const conciergeServices = [
  ...
  },
  {
    ...
    description: "Schedule a complimentary property walk-through with a KREDENCE consultant.",
  },
  {
    icon: MessageSquare,
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "KREDENCE offers seasonal maintenance, emergency repairs, finish restoration, and technology upgrades to extend the life of your installation.",
  },
];
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
    ...
    // Cleanup function to remove scripts when component unmounts (optional)
    return () => {
      // Note: We typically don't remove tracking scripts on unmount as they should persist
      // But if you want to clean up, you can do it here
    };
  }, []);
  ...
  return (
    <SiteLayout>
      ...
      >
        ...
        >
          <a href="tel:+971565686811" className="font-semibold">
            Call 971-565686811
          </a>
        </Button>
      </PageHeader>
              ...
              <CardContent>
                <div className="h-72 rounded-2xl bg-gradient-to-br from-secondary/20 via-secondary/10 to-primary/20 border border-border flex items-center justify-center text-center px-8">
                  <p className="text-lg text-muted-foreground">
                    Interactive map coming soon. Share your location and we'll connect you with the closest KREDENCE expert for on-site evaluation.
                  </p>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="absolute inset-0">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col lg:flex-row items-center justify-between gap-6">
            <div className="max-w-xl text-primary-foreground space-y-4">
              <h2 className="text-3xl sm:text-4xl font-bold">Talk with a KREDENCE specialist</h2>
