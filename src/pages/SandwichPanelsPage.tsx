...
const SandwichPanelsPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    metaDescription.setAttribute("content", " Insulated sandwich panels supplier in Dubai delivering cost-effective roofing and wall panel solutions for construction projects.");
    ...
    ogTitle.setAttribute("content", " Insulated Sandwich Panels Supplier in Dubai – www.kredencesteel.com ");
    ...
    ogDescription.setAttribute("content", " Insulated sandwich panels supplier in Dubai delivering cost-effective roofing and wall panel solutions for construction projects.");
  }, []);
