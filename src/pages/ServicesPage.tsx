  ...
  return (
    <SiteLayout>
      <PageHeader
        ...
        description="From sculptural privacy screens to fortified perimeter systems, KREDENCE pairs striking aesthetics with unwavering performance."
        variant="contrast"
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-xl space-y-5">
              ...
              <p className="text-lg leading-relaxed text-muted-foreground">
                Whether safeguarding critical assets or curating landmark destinations, KREDENCE delivers end-to-end
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
          <div className="space-y-6">
            ...
            <h2 className="text-4xl font-bold text-foreground">The KREDENCE Finish</h2>
          ...
          <div className="relative h-[420px] rounded-3xl overflow-hidden shadow-elegant">
            <img src={woodFence} alt="KREDENCE installation" className="w-full h-full object-cover" />
